...
import { add, subtract } from 'helperfunction/src';
    ...
    <>
      ...
      <div className={styles.mainContent}>
        ...
        <p className={styles.para}>
          Libraries can xsprevent waterfalls by offering a more centralized way to
        ...
        <br />
        <h2>Add:{add(1, 2)}, Subtract:{subtract(9,3)}</h2>
      </div>
    </>
  );
};
